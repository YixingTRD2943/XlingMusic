...
export const lightTheme = {
    ...
    colors: {
        ...
        textTertiary: Color("#333333").alpha(0.5).toString(),
        primary: "#f17d34",
...
export const sakuraTheme = {
    ...
    colors: {
        ...
        textTertiary: Color("#ffffff").alpha(0.5).toString(),
        primary: "#ff85ab",
        pageBackground: "#1a1a1a",
        shadow: "#ff85ab",
        appBar: "rgba(255,133,171,0.35)",
        appBarText: "#ffffff",
        musicBar: "#2d2d2d",
        musicBarText: "#ffffff",
        ...
        mask: "rgba(0,0,0,0.6)",
        backdrop: "rgba(255,133,171,0.15)",
        tabBar: "#2d2d2d",
        placeholder: "#424242",
        success: "#7eed9e",
        danger: "#ff6b6b",
        info: "#74b9ff",
        card: "rgba(255,133,171,0.15)",
        notification: "#2d2d2d",
...
export const autumnTheme = {
    ...
    colors: {
        ...
        textTertiary: Color("#fffaf0").alpha(0.5).toString(),
        primary: "#f97316",
        pageBackground: "#1a1a1a",
        shadow: "#f97316",
        appBar: "rgba(249,115,22,0.35)",
        appBarText: "#fffaf0",
        musicBar: "#2d2d2d",
        musicBarText: "#fffaf0",
...
export const matchaTheme = {
    ...
    colors: {
        ...
        textTertiary: Color("#e8f5e9").alpha(0.5).toString(),
        primary: "#a5d6a7",
        pageBackground: "#1a1a1a",
        shadow: "#a5d6a7",
        appBar: "rgba(165,214,167,0.35)",
        appBarText: "#e8f5e9",
        musicBar: "#2d2d2d",
        musicBarText: "#e8f5e9",
...
export const creamTheme = {
    ...
    colors: {
        ...
        textTertiary: Color("#fff8e1").alpha(0.5).toString(),
        primary: "#ffe082",
        pageBackground: "#1a1a1a",
        shadow: "#ffe082",
        appBar: "rgba(255,224,130,0.35)",
        appBarText: "#fff8e1",
        musicBar: "#2d2d2d",
        musicBarText: "#fff8e1",
...
export const imageTheme = {
    ...
    colors: {
        ...
        mask: "rgba(0,0,0,0.6)",
        backdrop: "rgba(187,134,252,0.15)",
        tabBar: "#2d2d2d",
        placeholder: "#424242",
        success: "#03dac6",
        danger: "#cf6679",
