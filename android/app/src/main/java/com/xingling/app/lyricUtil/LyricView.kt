package com.xingling.app.lyricUtil
...
class LyricView(private val reactContext: ReactContext) : View.OnTouchListener {
    ...
    fun showLyricWindow(initText: String?, options: Map<String, Any>) {
        try {
            if (windowManager == null) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (!android.provider.Settings.canDrawOverlays(reactContext)) {
                        Log.w("LyricView", "Overlay permission not granted, cannot show lyric")
                        return
                    }
                }
                ...
                try {
                    ...
                    Log.e("LyricView", "Failed to add lyric view: ${e.message}", e)
                    tv = null
                    windowManager = null
                    layoutParams = null
                    return
            ...
            Log.e("LyricView", "showLyricWindow exception: ${e.message}", e)
            hideLyricWindow()
        }
    }
    ...
    private fun listenOrientationChange() {
            ...
            orientationEventListener = object : OrientationEventListener(reactContext, SensorManager.SENSOR_DELAY_NORMAL) {
                override fun onOrientationChanged(orientation: Int) {
                    try {
                        ...
                        Log.e("LyricView", "onOrientationChanged exception: ${e.message}", e)
                    }
                }
            }
        }
        ...
        try {
            ...
            Log.e("LyricView", "Failed to enable orientation listener: ${e.message}", e)
        }
    }
    ...
    private fun unlistenOrientationChange() {
        try {
            ...
            Log.e("LyricView", "Failed to disable orientation listener: ${e.message}", e)
        }
    }
    ...
    fun hideLyricWindow() {
        try {
            if (windowManager != null) {
                tv?.let {
                    try {
                        ...
                        Log.e("LyricView", "Failed to remove lyric view: ${e.message}", e)
                    }
                    tv = null
                }
                windowManager = null
            ...
            Log.e("LyricView", "hideLyricWindow exception: ${e.message}", e)
        }
    }
    ...
    fun setText(text: String) {
        try {
            ...
            Log.e("LyricView", "setText exception: ${e.message}", e)
        }
    }
    ...
    fun setAlign(gravity: Int) {
        try {
            ...
            Log.e("LyricView", "setAlign exception: ${e.message}", e)
        }
    }
    ...
    fun setTopPercent(pct: Double) {
        try {
            ...
            Log.e("LyricView", "setTopPercent exception: ${e.message}", e)
        }
    }
    ...
    fun setLeftPercent(pct: Double) {
        try {
            ...
            Log.e("LyricView", "setLeftPercent exception: ${e.message}", e)
        }
    }
    ...
    fun setColors(textColor: String?, backgroundColor: String?) {
        try {
            ...
            Log.e("LyricView", "setColors exception: ${e.message}", e)
        }
    }
    ...
    fun setWidth(pct: Double) {
        try {
            ...
            Log.e("LyricView", "setWidth exception: ${e.message}", e)
        }
    }
    ...
    fun setFontSize(fontSize: Float) {
        try {
            ...
            Log.e("LyricView", "setFontSize exception: ${e.message}", e)
        }
    }
}